...
\todo[inline,color=green]{This behavior might be changed in the future. For now it does not allow custom ending files to be used unless you put your files to ''other'' directory.}
...
\begin{description}
    ...
    \item[message] Win mission after displaying this message from CBot with message() \todo{This was used somewhere in CeeBot, I have no idea if it still works}
...
\end{description}
\todo[color=purple,inline]{Original Colobot didn't support tool, drive, powermin, powermax and countTransported (it always counted transported items)}
