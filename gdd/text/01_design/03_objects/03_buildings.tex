...
\todo[inline]{I don't think radars have range. Maybe they should?}
...
\begin{description}
    ...
    \item[Power source:] regular or nuclear power cell
    \item[Duration of operation:] 1 second to aim the cannon. \todo{This part of code is commented out. Maybe it should be restored, for userlevels?}A preliminary research may offer an improvement in promptness, therefore more efficiency against flying targets
